...
namespace BrigandineGEDataEditor
{
    ...
    public class MemoryAccessor
    {
        ...
        private void GetData()
        {
            ...
            itemsDatas           = new ItemData[MemoryAddresses.Items.Length];
            thisViewAccessor.ReadArray(MemoryAddresses.Items.Address, itemsDatas, 0, MemoryAddresses.Items.Length);
            //itemsData           = itemsData;

            monsterInSummonDatas = new MonsterInSummonData[MemoryAddresses.MonsterInSummon.Length];
        ...
        { 
            ...
            if (adjustedAddress > thisViewAccessor.Capacity) return adjustedAddress.ToString("X");
